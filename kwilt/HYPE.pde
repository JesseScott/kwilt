...
public static class HOscillator extends HBehavior { 
  ...
  public void runBehavior(PApplet app) { 
    ...
    case HConstants.ROTATIONX: 
      _target.rotationX(v1); 
      break; 
    case HConstants.ROTATIONY: 
      _target.rotationY(v1); 
      break; 
    case HConstants.ROTATIONZ: 
      _target.rotationZ(v1); 
      break; 
...
public static class HVertex implements HLocatable { 
  ...
  public void adjust(float offsetU, float offsetV, float oldW, float oldH) { 
    ...
    switch(_numControlPts) { 
    case 2: 
      cx2( oldW*(_cu2 += offsetU) ).cy2( oldH*(_cv2 += offsetV) ); 
    case 1: 
      cx1( oldW*(_cu1 += offsetU) ).cy1( oldH*(_cv1 += offsetV) ); 
      break; 
    default: 
      break;
    }
  ...
  private float dv(float pv, float t) { 
    switch(_numControlPts) { 
    case 1: 
      return HMath.bezierTangent(pv, _cv1, _v, t); 
    case 2: 
      return HMath.bezierTangent(pv, _cv2, _cv2, _v, t); 
    default: 
      return _v - pv;
    }
  } 
